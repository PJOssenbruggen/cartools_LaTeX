...
%How are these conditions detected? Start by inspecting the scatter plot of Figure \ref{zip5} and the cluster of points around the point $(\bar{k}_D, \bar{q}_D)$ and $k_{D_1},k_{D_2} \ldots,k_{D_9}$ and $q_{D_1},q_{D_2} \ldots,q_{D_9}$. 
